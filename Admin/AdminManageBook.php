        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    $query = "SELECT Book.*, Categories.CategoryName 
                            FROM Book 
                            JOIN Categories ON Book.CategoryId = Categories.CategoryId";

                    if(!empty($search)) {
                        $query .= " WHERE 
                            Book.Title LIKE '%$search%' OR
                            Book.Author LIKE '%$search%' OR
                            Categories.CategoryName LIKE '%$search%'";
                    }
                        ...
                        <div class="card book-card p-2">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Delete Button -->
                                    <div class="col-md-6 mb-3">
                                        <a href="Delete_Book.php?id=<?php echo $row['BookId']; ?>" 
