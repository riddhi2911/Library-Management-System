...
// Fetch issued books (latest first)
$query = "
SELECT IssueBook.*, Users.Name, Book.Title
FROM IssueBook
...
<div class="sidebar">
    ...
    <a href="AdminIssueBook.php" class="<?php if(basename($_SERVER['PHP_SELF'])=='AdminIssueBook.php') echo 'active'; ?>"><i class="fas fa-arrow-up me-2"></i> Issued Books</a>
...
<div class="main">
    ...
    <div class="header mb-4">
        <h4>Librarian Issue Book Panel</h4>
    </div>

    <div class="container mt-5">

        <div class="card p-4 shadow">
            <h4 class="mb-4 text-center">Issued Books List</h4>
            ...
            <table class="table table-bordered table-hover text-center">
                ...
                <tbody>
                    ...
                    if(mysqli_num_rows($result) > 0){
                        ...
                        $total = mysqli_num_rows($result); // total rows
